...
if __name__ == '__main__':
    apk_dir = r'/opt/apks/open_source/instrument/monkey'
    for filename in os.listdir(apk_dir):
        if len(filename.split(".")) == 2 and filename.split(".")[1] == "apk":
            ...
            outdir = apk_dir + '/' + filename.split(".")[0] + "_monkeyout"
            ...
            stoat_pipe = subprocess.Popen(args='exec python2.7 /opt/code/monkey/main.py',
